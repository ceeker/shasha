    ...
    <div class="content">
      ...
      <div class="touming"></div>
        <table summary="莎莎新闻资讯列表">
          ...
          <thead>
            <tr>
              <th scope="col" width="80"><fmt:message key="fileno" bundle="${bundle}"/> </th>
              <th scope="col" width="200"><fmt:message key="filename" bundle="${bundle}"/> </th>
              <th scope="col" width="300"><fmt:message key="description" bundle="${bundle}"/> </th>
              <th scope="col" width="130"><fmt:message key="filetime" bundle="${bundle}"/> </th>
          ...
          <c:forEach var="num" items="${page2.list}">
            <tr>
                  ...
                  <td><a href="/translation/servlet/DownFileServlet?id=${num.id}"><fmt:message key="download" bundle="${bundle}"/></a></td>
              </tr>
              </c:forEach>
          </tbody>
        </table>
